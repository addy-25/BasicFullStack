    ...
    <>
      ...
      <div className="auth-root">
        ...
        <div className="auth-card">
          ...
          <h1 className="auth-title">Begin your<br /><em>journey.</em></h1>
          <p className="auth-subtitle">Create an account to start growing your tasks.</p>
          ...
          <button className={`btn-primary${loading ? " loading" : ""}`} onClick={signup}>
